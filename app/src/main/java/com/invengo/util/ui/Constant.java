...
//    陌生人
    ...
    //多国语言设置
    String MORE_COUNTRY_LANAGUAGE = "more_country_lanaguage";
    //好友辅助验证
    String CHANGE_PHONENUM_FRIEND_ARCILLARY = "change_phonenum_friend_arcillary";
    //好友辅助验证-生命周期状态
    String CHANGE_PHONENUM_FRIEND_ARCILLARY_CRCLE = "change_phonenum_friend_arcillary_crcle";
